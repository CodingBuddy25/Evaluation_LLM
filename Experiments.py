...
def plotting_graphs(final_data, finaldata2):
    #preprocessed_data2
    Menu = 10
    ...
    while Menu != 0:
        ...
        if Menu ==6:
            ...
            fig, axs = plt.subplots(2, 3, figsize = (14,21),squeeze=False, constrained_layout=True)
            x = np.arange(7)
...
if __name__ == "__main__":
    ...
    while Menu != 0:
        ...
        if Menu == 2:
            ...
            preprocessed_data = [{'CP': 0, 'SP': 0, 'Non-AR': 2, 'Non-AA': 10, 'SM or PR': 2, 'None': 7, 'Law': 0},
                               {'CP': 0, 'SP': 9, 'Non-AR': 0, 'Non-AA': 0, 'SM or PR': 0, 'None': 1, 'Law': 0},
                               {'CP': 9, 'SP': 0, 'Non-AR': 0, 'Non-AA': 0, 'SM or PR': 0, 'None': 9, 'Law': 2},
                               {'CP': 5, 'SP': 2, 'Non-AR': 0, 'Non-AA': 8, 'SM or PR': 4, 'None': 0, 'Law': 3},
                               {'CP': 0, 'SP': 2, 'Non-AR': 0, 'Non-AA': 9, 'SM or PR': 1, 'None': 1, 'Law': 0},
